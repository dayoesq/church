...
trait ValidatesFieldsBeforeUpdates
{
     ...
     * @return void
     */
    public function updateUserFieldsByAdmin(Request $request, Model $model): void
    {

        $this->updateUserFieldsBySelf($request, $model);
     ...
     * @return void
     */
    public function updateUserFieldsBySelf(Request $request, Model $model): void
    {
