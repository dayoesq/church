                            ...
                            <div className='lg:pr-4'>
                                <div className='lg:max-w-lg'>
                                    ...
                                    <p className='mt-6 text-xl leading-8 text-gray-700'>
                                        ...
                                        within the Redeemed Christian Church of
                                        God. Founded 14 years ago in response to
                                        a divine revelation received by Pastor
                                        Mercy of Jesus Center Parish, Grace
                                        Chapel has flourished under the
                                        dedicated leadership of Pastor Björn and
                                        Laura Bergval. This narrative of faith,
                                        unity, and spiritual growth reflects the
                                        congregation&apos;s unwavering
                                        commitment to the vision set by Pastor
                                        E.A Adeboye. From its inspired inception
                                        to becoming a radiant spiritual haven,
                                        Our history at Grace Chapel Parish is a
                                        testament to the transformative power of
                                        collective worship and divine
                                        providence.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className='lg:pr-4'>
                                <div className='max-w-xl text-base leading-8 text-gray-700 lg:max-w-lg'>
                                    <p>
                                        ...
                                        Chapel Parish were planted in the
                                        fertile soil of faith and divine
                                        inspiration. The inception of this
                                        vibrant congregation was not just a mere
                                        happenstance but a result of a profound
                                        revelation received by Pastor Mercy of
                                        Jesus Center Parish, nestled in the
                                        serene city of Turku, Finland. This
                                        divine encounter became the catalyst for
                                        the birth of Grace Chapel, a radiant
                                        beacon within the Redeemed Christian
                                        Church of God (RCCG) family, under the
                                        revered leadership of Pastor E.A
                                        Adeboye.{' '}
                                        <p className='mb-4'>
                                            ...
                                            Bergval, a dedicated shepherd, has
                                            been instrumental in nurturing the
                                            spiritual growth of the parish,
                                            leading the congregation on a
                                            journey of profound transformation.
                                        </p>{' '}
                                        <p className='mb-4'>
                                            The story of Grace Chapel is one of
                                            steadfast dedication and divine
                                            providence. It is a tale of a
                                            community that emerged from the
                                            vision birthed in the heart of
                                            Pastor Mercy, radiating the light of
                                            faith across the Finnish landscape.
                                            The parish has become a testament to
                                            the power of unity and the strength
                                            found in collective worship. As the
                                            years unfolded, Grace Chapel has
                                            been a place of worship, fellowship,
                                            and spiritual enrichment.{' '}
                                        </p>
                                        <p className='mb-4'>
                                            The congregation&apos;s commitment
                                            to the teachings of RCCG and the
                                            vision set by Pastor E.A Adeboye has
                                            been unwavering, creating a
                                            spiritual haven where individuals
                                            find solace, purpose, and a sense of
                                            belonging. Our history at Grace
                                            Chapel Parish is not just a
                                            recounting of events; it is a
                                            narrative of divine orchestration,
                                            unwavering faith, and the tireless
                                            efforts of a devoted community. It
                                            stands as a testament to the
                                            transformative power of faith
                                            communities, where the seeds of
                                            revelation sown by Pastor Mercy have
                                            borne fruits of redemption, unity,
